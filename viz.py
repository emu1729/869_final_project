...
def get_args():
    ...
    parser.add_argument("--weights_path", type = str, default = 'first_try.h5', help = 'Path to network weights file')
    parser.add_argument("--layer", type = str, default = 'conv3', help = 'Name of layer to use. Uses layer names in model.py')
    parser.add_argument("--num_filters", type = int, default = 16, help = 'Number of filters to vizualize, starting from filter number 0.')
    parser.add_argument("--size", type = int, default = 150, help = 'Image width and height')
